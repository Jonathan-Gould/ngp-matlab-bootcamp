...
disp 'Hello world!' %[output:4776d167]
...
% assign the value of 365 * 24 to the variable hours_in_a_year


% assign the value of 365 * 24 * 60 to the variable minutes_in_a_year

%%
%[text] You may notice that the variables `hours_in_a_year` and `minutes_in_a_year` showed up in the side bar, titled Workspace. This is where MATLAB stores all your variables so you can keep track of them. You'll also notice that the value associated with each variable is the result of the math problem you assigned to it.
