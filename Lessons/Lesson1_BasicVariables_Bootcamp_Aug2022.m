...
disp("Hello!") % make sure to "Run Section" to update the output %[output:2246e8c9]
...
3 + 19 %[output:9510b619]

19 + 3 %[output:51c43b9d]

3+19 %[output:63a66960]

3+   19 %[output:28d5f4a9]

%command MATLAB to subtract 91 - 28
91 - 28 %[output:2d96ef9c]
...
6 * 13 %[output:2629021f]

%command MATLAB to divide 98 / 4
98 / 4 %[output:64b0c403]
...
result1 = 6 * 13 %[output:3c087bb3]
result1=6*13 %[output:2ccb411b]


%assign the value of 98 / 4 to  the variable result2
result2 = 98 / 4 %[output:42e4ac92]


result1 + result2 %[output:5165526b]
%%
...
abs(total) %[output:5bf4e93e]

sqrt(9) %[output:3a48bce4]
...
apples + 6 %[output:2c507588]
disp(apples) %[output:3b396859]
%%
...
apples_after_shopping = apples + 6;
disp(apples_after_shopping) %[output:94f1e6bd]
...
apples_after_pie = apples_after_shopping - 4;
disp(apples_after_pie) %[output:94552f9c]


alsdkfjlaskdjf= apples_after_shopping - 4;
%%
...
class(bagles) %[output:1555eb68]
class(people_in_room) %[output:4aac3e80]
...
firstname = "Jonathan" %[output:5da01c01]
lastname = "Gould" %[output:48057e70]

class(firstname) %[output:8f16184c]
%%
...
strcat(firstname, lastname) %[output:92e83161]
...
strcat(firstname, " " , lastname) %[output:55dc65fc]


fullname_with_space = "";
%%

fullname_with_space = strcat(fullname_with_space, " " , lastname);
disp(fullname_with_space) %[output:29d71998]
%%
...
answer1 = 42 == 42 %[output:6580b5d2]
answer2 = 13 == 42 %[output:06d8877b]

yes + yes + yes %[output:29ce4b7a]
...
isnumeric(4) %[output:728b0a61]
isnumeric(firstname) %[output:31863432]

isnan(nan) %[output:2393cd75]
...
%create some arrays
array1 = [1 2] %[output:86781fb1]

array2 = [1 2 4 7] %[output:88bd37b5]
array2_and_a_half = [1, 2, 4, 7] %[output:4750cf61]

array3 = [[1 2]; [3 4]] %[output:13b514ce]

array4 = [1 2 3; 4 5 6; 7 8 9] %[output:565203c3]
...
two_dim_matrix = [10 20;  30 40] %[output:1b206d90]
...
big_matrix(1,1) %[output:503eadc8]
big_matrix(2,1) %[output:7f2a60e8]
big_matrix(3,1) %[output:13c1a580]

big_matrix(1,2) %[output:2ed9ea98]

big_matrix(5,10) %[output:27390a69]

big_matrix(end, end) %[output:5ef7b657]
%%
...
big_matrix(big_matrix > 5) %[output:6a424752]
%%
%[text] 
%[text] ## Functions
...
%---
%[output:2246e8c9]
%   data: {"dataType":"text","outputData":{"text":"Hello!\n","truncated":false}}
%---
%[output:9510b619]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"22"},"version":0}
%---
%[output:51c43b9d]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"22"},"version":0}
%---
...
%---
%[output:2d96ef9c]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"63"},"version":0}
%---
%[output:2629021f]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"78"},"version":0}
%---
%[output:64b0c403]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"24.5000"},"version":0}
%---
%[output:72efce04]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"102.5000"},"version":0}
%---
%[output:3c087bb3]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"result1","rows":"1","value":"78"},"version":0}
%---
%[output:2ccb411b]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"result1","rows":"1","value":"78"},"version":0}
%---
%[output:42e4ac92]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"result2","rows":"1","value":"24.5000"},"version":0}
%---
%[output:5165526b]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"102.5000"},"version":0}
%---
...
%---
%[output:2c507588]
%   data: {"dataType":"not_yet_implemented_variable","outputData":{"columns":"1","name":"ans","rows":"1","value":"8"},"version":0}
%---
%[output:3b396859]
%   data: {"dataType":"text","outputData":{"text":"     2\n\n","truncated":false}}
%---
%[output:1f75046a]
%   data: {"dataType":"text","outputData":{"text":"    14\n\n","truncated":false}}
%---
%[output:94f1e6bd]
...
%---
%[output:5da01c01]
%   data: {"dataType":"textualVariable","outputData":{"name":"firstname","value":"\"Jonathan\""}}
%---
%[output:48057e70]
%   data: {"dataType":"textualVariable","outputData":{"name":"lastname","value":"\"Gould\""}}
%---
%[output:8f16184c]
%   data: {"dataType":"textualVariable","outputData":{"name":"ans","value":"'string'"}}
%---
%[output:92e83161]
%   data: {"dataType":"textualVariable","outputData":{"name":"ans","value":"\"JonathanGould\""}}
%---
%[output:55dc65fc]
%   data: {"dataType":"textualVariable","outputData":{"name":"ans","value":"\"Jonathan Gould\""}}
%---
%[output:29d71998]
