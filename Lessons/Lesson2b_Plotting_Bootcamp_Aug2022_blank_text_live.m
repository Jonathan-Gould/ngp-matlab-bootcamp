...
%[text] So, using that simple command, MATLAB did its thing and just chose the sizes of the histogram bins and the size of the axes. But if we wanted a different degree of specificity here, we can choose our own number of bins sing the `nbins` argument to he `histogram()` function.
%%
